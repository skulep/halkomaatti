...
fireb shortcode <?php echo do_shortcode ( '[custom_firebase]' ); ?>
		...
		<div class="notif-holder">
			<div class="text-center">
				<a href="https://firewood2go.eu/admin-notifications/" class="btn btn-primary btn-lg text-center justify-content-center" role="button" aria-disabled="true">All notifications</a>
			</div>
